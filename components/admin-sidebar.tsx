  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="fixed inset-y-0 left-0 z-50 flex w-[220px] flex-col bg-[#07111f] text-slate-200 shadow-2xl shadow-black/40"
      >
        {/* Logo */}
                   ...
                   return (
                      <motion.button
                        ...
                        onClick={() => navigateTo(item.tab)}
                         className={cn(
                           "relative flex items-center gap-1.5 rounded-md px-2.5 py-1 text-left transition-all duration-200 w-full",
                           isActive
